...
- **Status:** MODERATE DEFICIT (-1.2 ft localized drop in karst table, balanced by stable surface storage)
- **Quantified Index Score:** -1.2 ft net deviation from seasonal baseline.
